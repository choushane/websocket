...
def _get_handshake_headers(resource, host, port, options):
    ...
    if "Display_name" in options and options["Display_name"] is not None:
        headers.append("Display_name: %s" % options["Display_name"])
...
def _create_sec_websocket_key():
    return base64encode(os.urandom(16)).encode('utf-8').strip()
